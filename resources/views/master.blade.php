    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-lower ">Volf's bakery</span>
            </h1>
        </header>
        <!-- Navigation-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="store">Opening hours</a></li>
...
<footer class="footer text-faded text-center py-5">
            <div class="container"><p class="m-0 small">Copyright &copy; Volf Craizen inc 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
